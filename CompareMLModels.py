...
models.append(('LinearRegression', LogisticRegression(solver='liblinear', multi_class='ovr')))
# Polynomial of degree 2 regression (LinearRegression)
models.append(('LinearRegression degree 2', LogisticRegression(solver='liblinear', multi_class='ovr')))
# Polynomial of degree 3 regression (LinearRegression)
models.append(('LinearRegression degree 3', LogisticRegression(solver='liblinear', multi_class='ovr')))
